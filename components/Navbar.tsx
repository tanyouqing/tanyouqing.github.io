        ...
        <header className="fixed top-0 left-0 right-0 z-50">
          ...
          rounded-2xl px-5 py-3 shadow-lg shadow-black/5">
                    ...
                    <ul className="hidden md:flex items-center gap-1">
                      ...
                      ${isActive
                                                ? 'bg-gradient-to-r from-cyan-500/15 to-orange-400/10 text-cyan-500 dark:text-cyan-400'
                ...
                {/* Mobile Dropdown */}
                {menuOpen && (
                    <div className="md:hidden mt-2 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl
            border border-white/30 dark:border-slate-700/50
